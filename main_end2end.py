...
def train(opt):
    ...
    Mine_model_init,Mine_model_IDH,Mine_model_1p19q,Mine_model_CDKN,Mine_model_Graph,Mine_model_His,Mine_model_Cls\
        ,opt_init,opt_IDH,opt_1p19q,opt_CDKN,opt_Graph,opt_His,opt_Cls=get_model(opt,if_end2end=True)
    ...
    trainDataset = dataset_mine.Our_Dataset(phase='Train',opt=opt,if_end2end=True)
    valDataset = dataset_mine.Our_Dataset(phase='Val', opt=opt,if_end2end=True)
    testDataset = dataset_mine.Our_Dataset(phase='Test',opt=opt,if_end2end=True)
