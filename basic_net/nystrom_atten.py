...
class NystromAttention(nn.Module):
    ...
    def forward(self, x, mask = None, return_attn = False):
        ...
        sim1 = einsum(einops_eq, q.float(), k_landmarks.float())
        sim2 = einsum(einops_eq, q_landmarks.float(), k_landmarks.float())
        sim3 = einsum(einops_eq, q_landmarks.float(), k.float())
